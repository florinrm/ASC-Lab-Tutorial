...
int main(void)
{
    ...
    cudaMemcpyAsync(device_array_x, host_array_x, num_bytes, cudaMemcpyHostToDevice);
    cudaMemcpyAsync(device_array_y, host_array_y, num_bytes, cudaMemcpyHostToDevice);
    ...
    cudaMemcpyAsync(host_array_x, device_array_x, num_bytes, cudaMemcpyDeviceToHost);
    cudaMemcpyAsync(host_array_y, device_array_y, num_bytes, cudaMemcpyDeviceToHost);
